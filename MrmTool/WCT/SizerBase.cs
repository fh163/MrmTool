...
public partial class SizerBase : Control
{
    ...
    /// </remarks>
    protected virtual bool OnDragHorizontal(double horizontalChange) => false;
    ...
    /// in <see cref="OnDragStarting"/> to provide the desired change.
    /// </remarks>
    protected virtual bool OnDragVertical(double verticalChange) => false;
    ...
    public SizerBase()
    {
        ...
        Style = Application.Current.Resources["DefaultSizerBaseStyle"] as Style;
    }
